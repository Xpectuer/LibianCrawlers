...
//       const ncbi_fmt = ref_works as any 
//       // if('pubmed_str' in ref_)
//       if (!ncbi_fmt) {
...
//       ) =>
//         ncbi_fmt.entries_multiple.find((it:any) => it.label === label)
//           ?.values_join ?? null;
//       const get_doi = () => {
...
//       };
//       const get_issn = () => {
//         const values = ncbi_fmt.entries_multiple.find((it:any) => it.label === "IS")
//           ?.values;
//         if (typeof values === "undefined" || values.length <= 0) {
//           return null;
//         }
//         const issn_list = values.map((value:any) => {
...
//         authors: ncbi_fmt.authors.map((it:any) => {
//           return {
...
//             .find((it:any) => it.label === "OT")
//             ?.values.map((it:any) => ({ text: it }))
//         )
