...
<span class="line"><span>      只生成 nocodb 的类型文件。</span></span>
<span class="line"><span></span></span>
<span class="line"><span>-----------------------------------------</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">deno</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> task</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> init:code_gen</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> --skip-existed</span></span></code></pre></div></div></div><h3 id="检查结果" tabindex="-1">检查结果 <a class="header-anchor" href="#检查结果" aria-label="Permalink to &quot;检查结果&quot;">​</a></h3><p>完成后，初始化工作就已经完成。然而，如果您需要适配并运行 <code>general_data_process</code> 目录下的公用脚本，您需要手动处理 TypeScript 类型导入。</p><p>您可以通过运行以下命令，检查生成的类型是否满足公开脚本的类型推断，并运行测试：</p><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">deno</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> tasks</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> step:check</span></span></code></pre></div>`,12)]))}const k=s(p,[["render",l]]);export{g as __pageData,k as default};
